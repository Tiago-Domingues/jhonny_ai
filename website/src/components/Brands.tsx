    ...
    >
      {failed ? (
        ...
        <img
          ...
          className="pointer-events-none max-h-10 w-auto max-w-[160px] object-contain brightness-0 invert opacity-90 transition duration-300 hover:opacity-100 sm:max-h-11"
        />
      )}
    </Link>
  );
