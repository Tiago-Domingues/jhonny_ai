  ...
  pt: {
    ...
    shop: {
      ...
      items: [
        ...
        { id: "essentials", title: "Essenciais", desc: "Parafina, ponchos, praia, earplugs, reparações e lifestyle." },
  ...
  en: {
    ...
    shop: {
      ...
      items: [
        ...
        { id: "essentials", title: "Essentials", desc: "Wax, ponchos, beach gear, earplugs, repairs and lifestyle." },
  ...
  zh: {
    ...
    shop: {
      ...
      items: [
        ...
        { id: "essentials", title: "必备用品", desc: "冲浪蜡、浴袍斗篷、海滩用品、耳塞、修补与生活方式。" },
