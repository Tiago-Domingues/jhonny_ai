...
export const translations: Record<Locale, Dict> = {
  pt: {
    ...
    menuItems: {
      ...
      "SURF ESSENCIALS / LIFESTYLE": "Lifestyle",
      "BODYBOARD / BOARDS": "Pranchas",
      "BODYBOARD / FINS": "Pés de pato",
      "BODYBOARD / FINS (PÉS DE PATO)": "Pés de pato",
      "BODYBOARD / LEASHES": "Leashes",
      "BODYBOARD / ACESSORIES": "Acessórios",
      "BODYBOARD / BAGS": "Sacos",
      "BODYBOARD / BOARDSOCKS": "Boardsocks",
      "CLOTHING / MEN": "Homem",
      "CLOTHING / WOMEN": "Mulher",
      "CLOTHING / KIDS": "Crianças",
      "CLOTHING / HATS": "Chapéus",
      "CLOTHING / JSS MERCH": "JSS Merch",
      "JSS MERCH / T-SHIRTS & TOPS": "T-shirts & tops",
      "JSS MERCH / SWEATERS & HOODIES": "Sweaters & hoodies",
      "JSS MERCH / SHORTS": "Shorts",
      "JSS MERCH / PANTS": "Calças",
      "JSS MERCH / HATS": "Chapéus",
      "JSS MERCH / SURF PONCHO": "Surf poncho",
      ...
      "TRAVEL / EVERYDAY CARRY": "Everyday carry",
      "TRAVEL / DUFFEL BAGS": "Sacos de viagem",
      "TRAVEL / TROLLEYS": "Trolleys",
      "SURFSKATE / PROTECTIVE GEAR": "Proteção",
      "SURFSKATE / ACESSORIES": "Acessórios",
      "LIFESTYLE / YETI GEAR": "YETI",
      "LIFESTYLE / DRINKWEAR": "Drinkware",
      "LIFESTYLE / DRINKWEAR & ACESSORIES": "Drinkware",
      "LIFESTYLE / BOOKS": "Livros",
      "SURFGEAR / CAR ACESSORIES": "Acessórios de carro",
      Man: "Homem",
      Woman: "Mulher",
      Kids: "Criança",
      Clothing: "Roupa",
      ...
      Boardbags: "Capas",
      Essentials: "Surf Essenciais",
      "Surf Essencials": "Surf Essenciais",
      "Surf Essentials": "Surf Essenciais",
      Fins: "Quilhas",
    },
    hero: {
    ...
    shop: {
      ...
      subtitle:
        "Das melhores marcas mundiais à nossa própria linha. Compra online ou passa pela loja para experimentar e levar o melhor para a água.",
      soon: "Compra online",
      explore: "Ver na loja",
      items: [
        ...
        { id: "clothing", title: "Vestuário", desc: "Roupa, calçado, hats e acessórios." },
        { id: "jssMerch", title: "JSS Merch", desc: "A linha própria da Jhonny Surf Store." },
        { id: "essentials", title: "Surf Essenciais", desc: "Parafina, ponchos, praia, earplugs, reparações e lifestyle." },
        { id: "bodyboard", title: "Bodyboard", desc: "Pranchas, pés de pato, leashes e acessórios de bodyboard." },
        { id: "surfskate", title: "Surfskate", desc: "Surfskates, proteção e acessórios para treinar em terra." },
    ...
    footer: {
      ...
      developedBy: "Desenvolvido por DatabyPassion AI solutions",
      shopTitle: "Loja",
      storeTitle: "A Loja",
      supportTitle: "Apoio",
    ...
    whatsapp: {
      bubble: "Olá Lenda. Como posso ajudar?",
    },
    account: {
      title: "A minha conta",
      signIn: "Entrar",
  ...
  en: {
    ...
    menuItems: {
      ...
      "SURFGEAR / RACK": "Racks",
      "SURFGEAR / KEYVAULT": "Keyvault",
      "SURFGEAR / CAR ACESSORIES": "Car accessories",
      ...
      "TRAVEL / EVERYDAY CARRY": "Everyday carry",
      "TRAVEL / DUFFEL BAGS": "Duffel bags",
      "TRAVEL / TROLLEYS": "Trolleys",
      "SURFSKATE / PROTECTIVE GEAR": "Protective gear",
      "SURFSKATE / ACESSORIES": "Accessories",
      "LIFESTYLE / YETI GEAR": "YETI",
      "LIFESTYLE / DRINKWEAR": "Drinkware",
      "LIFESTYLE / DRINKWEAR & ACESSORIES": "Drinkware",
    ...
    shop: {
      ...
      subtitle:
        "From the best brands in the world to our own line. Shop online or drop by the store to try it on and take the best to the water.",
      soon: "Shop online",
      ...
      items: [
        ...
        { id: "clothing", title: "Apparel", desc: "Apparel, footwear, hats and accessories." },
        { id: "jssMerch", title: "JSS Merch", desc: "Jhonny Surf Store's own line." },
        { id: "essentials", title: "Surf Essentials", desc: "Wax, ponchos, beach gear, earplugs, repairs and lifestyle." },
        { id: "bodyboard", title: "Bodyboard", desc: "Boards, swim fins, leashes and bodyboard accessories." },
        { id: "surfskate", title: "Surfskate", desc: "Surfskates, protective gear and accessories for land training." },
    ...
    footer: {
      ...
      madeWith: "Carcavelos · Cascais · Lisboa",
      developedBy: "Developed by DatabyPassion AI solutions",
      shopTitle: "Shop",
  ...
  zh: {
    ...
    menuItems: {
      ...
      "SURF ESSENCIALS / LIFESTYLE": "生活方式",
      "BODYBOARD / BOARDS": "趴板",
      "BODYBOARD / FINS": "脚蹼",
      ...
      "BODYBOARD / BAGS": "包袋",
      "BODYBOARD / BOARDSOCKS": "板袜",
      "CLOTHING / MEN": "男士",
      "CLOTHING / WOMEN": "女士",
      "CLOTHING / KIDS": "儿童",
      "CLOTHING / HATS": "帽子",
      "CLOTHING / JSS MERCH": "JSS 周边",
      "JSS MERCH / T-SHIRTS & TOPS": "T恤与上衣",
      "JSS MERCH / SWEATERS & HOODIES": "卫衣与连帽衫",
      "JSS MERCH / SHORTS": "短裤",
      "JSS MERCH / PANTS": "长裤",
      "JSS MERCH / HATS": "帽子",
      "JSS MERCH / SURF PONCHO": "冲浪斗篷",
      ...
      "FOOTWEAR / WOMEN": "女士",
      "TRAVEL / BACKPACKS": "背包",
      "TRAVEL / EVERYDAY CARRY": "日常携带",
      "TRAVEL / DUFFEL BAGS": "旅行袋",
      "TRAVEL / TROLLEYS": "拉杆箱",
      "SURFSKATE / PROTECTIVE GEAR": "护具",
      "SURFSKATE / ACESSORIES": "配件",
      "LIFESTYLE / YETI GEAR": "YETI",
      ...
      "Surf Essencials": "Surf Essencials",
      "Surf Essentials": "Surf Essencials",
      Fins: "鱼鳍",
    },
    hero: {
      eyebrow: "冲浪 · 大海 · 风格",
    ...
    shop: {
      eyebrow: "商店",
      title: "每一浪都有合适装备",
      subtitle: "从全球顶尖品牌到我们的自有系列。可在线购买，或到店试穿试用，把最好的装备带下水。",
      soon: "在线购买",
      explore: "进入商店",
      items: [
        ...
        { id: "clothing", title: "服装", desc: "服装、鞋履、帽子与配件。" },
        { id: "jssMerch", title: "JSS Merch", desc: "Jhonny Surf Store 自有系列。" },
        { id: "essentials", title: "Surf Essencials", desc: "冲浪蜡、浴袍斗篷、海滩用品、耳塞、修补与生活方式。" },
        { id: "bodyboard", title: "趴板", desc: "趴板、脚蹼、脚绳与趴板配件。" },
        { id: "surfskate", title: "陆地冲浪", desc: "陆地冲浪板、护具与配件，适合陆地训练。" },
    ...
    footer: {
      ...
      rights: "版权所有。",
      madeWith: "Carcavelos · Cascais · Lisboa",
      developedBy: "由 DatabyPassion AI solutions 开发维护",
      shopTitle: "商店",
      storeTitle: "门店",
      supportTitle: "支持",
      infoTitle: "信息",
