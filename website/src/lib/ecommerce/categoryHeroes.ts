...
export const CATEGORY_HEROES: Record<CategoryGroupKey, CategoryHero> = {
  ...
  clothing: {
    image: "/brand/categories/hero-lifestyle.jpg",
    labelPt: "Vestuário",
    labelEn: "Apparel",
    labelZh: "服装",
  ...
  jssMerch: {
    image: "/brand/categories/hero-jss-merch.jpg",
    labelPt: "JSS Merch",
    labelEn: "JSS Merch",
    labelZh: "JSS Merch",
  ...
  travel: {
    image: "/brand/categories/hero-travel.jpg",
    labelPt: "Viagem",
    labelEn: "Travel",
    labelZh: "旅行",
  ...
  surfskate: {
    image: "/brand/categories/hero-surfskate.jpg",
    labelPt: "Surfskate",
    labelEn: "Surfskate",
    labelZh: "陆地冲浪",
